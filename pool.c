...
void print_statistics(struct pool_info *pool)
{
	...
	fprintf(pool->file_output,"%-30s	%-20d	(%Lf%%)\n","Chunk all",pool->chunk_all,(long double)pool->chunk_all/(long double)pool->chunk_sum);
	fprintf(pool->file_output,"%-30s	%d\n","Window type",pool->window_type);
	fprintf(pool->file_output,"%-30s	%d MB\n","Window size",pool->window_size);
	...
	fprintf(pool->file_output,"%-30s	%-20d	(%Lf%%)\n","Num of write IO",pool->req_sum_write,100*(long double)pool->req_sum_write/(long double)pool->req_sum_all);
	...
	fprintf(pool->file_output,"%-30s	%-20Lf	(%Lf%%)\n","Size of write IO (MB)",pool->req_size_write,100*pool->req_size_write/pool->req_size_all);
	fprintf(pool->file_output,"%-30s	%Lf\n","Avg Size of all IO (MB)",pool->req_size_all/pool->req_sum_all);
	fprintf(pool->file_output,"%-30s	%Lf\n","Avg Size of read IO (MB)",pool->req_size_read/pool->req_sum_read);
	fprintf(pool->file_output,"%-30s	%Lf\n","Avg Size of write IO (MB)",pool->req_size_write/pool->req_sum_write);
	...
	fprintf(pool->file_output,"%-30s	%-20d	(%Lf%%)\n","Num of Seq. write IO",pool->seq_sum_write,100*(long double)pool->seq_sum_write/(long double)pool->seq_sum_all);
	...
	fprintf(pool->file_output,"%-30s	%-20Lf	(%Lf%%)\n","Size of Seq. write IO (MB)",pool->seq_size_write,100*pool->seq_size_write/pool->seq_size_all);
	...
	fprintf(pool->file_output,"%-30s	%Lf\n","Avg Size of Seq. write IO (MB)",pool->seq_size_write/pool->seq_sum_write);
	...
	fprintf(pool->file_output,"%-30s	%-20d	(%Lf%%)\n","Num of Seq. write stream",pool->seq_stream_write,100*(long double)pool->seq_stream_write/(long double)pool->seq_stream_all);
	...
	fprintf(pool->file_output,"%-30s	%Lf MB\n","Avg Size of Seq. write stream",pool->seq_size_write/pool->seq_stream_write);
	fflush(pool->file_output);
